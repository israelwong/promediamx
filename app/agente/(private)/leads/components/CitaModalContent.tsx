/**
 * Ruta actual desde agente: /app/agente/(private)/leads/components/CitaModalContent.tsx
 */
"use client";
...
import {
    User, Mail, Phone, Briefcase, School, GraduationCap, Star,
    // MessageSquare, 
    Edit, NotebookText
} from 'lucide-react';
...
export default function CitaModalContent({ lead, initialNotes }: CitaModalContentProps) {
    ...
    const handleEdicionAvanzada = () => {
        window.open(`/agente/leads/${lead.id}`, '_blank');
