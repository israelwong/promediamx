/**
 * Ruta actual: /Users/israelwong/Documents/Desarrollo/promedia-app/app/agente/(private)/kanban/components/LeadCard.tsx
 */
'use client';
...
import { GripVertical, Calendar, Building, UserCircle2 } from 'lucide-react';
        ...
        <div ref={setNodeRef} style={style} {...attributes}>
            <Card
                ...
                <CardContent className="p-3">
                    ...
                    {/* --- INICIO DE LA MEJORA --- */}
                    {/* Muestra el nombre del agente si el lead tiene uno asignado */}
                    {lead.agente && (
