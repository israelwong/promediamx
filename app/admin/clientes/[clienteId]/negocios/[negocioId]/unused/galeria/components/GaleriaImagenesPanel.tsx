...
} from '@/app/admin/_lib/unused/imagenGaleriaNegocio.actions'; // Ajusta la ruta
import { ImagenGaleriaNegocio } from '@prisma/client'; // Importa el tipo de Prisma
import { ImagenGaleriaNegocioDetallesInput, ImagenGaleriaNegocioOrdenData } from '@/app/admin/_lib/unused/imagenGaleriaNegocio.actions'; // Importa tipos específicos
// --- Icons ---
