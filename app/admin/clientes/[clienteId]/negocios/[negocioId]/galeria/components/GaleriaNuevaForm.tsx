...
// --- Acción y Tipos ---
import { crearGaleriaNegocio } from '@/app/admin/_lib/galeriaNegocio.actions'; // Ajusta la ruta
import type { ActionResult } from '@/app/admin/_lib/galeriaNegocio.actions'; // Importar tipo ActionResult si está definido ahí
