    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div>
                                ...
                                {errors.valorEstimado && (
                                    <p className="text-red-500 text-xs mt-1">{errors.valorEstimado.message}</p>
                                )}
                            </div>
                        </CardContent>
                    </Card>
                                ...
                                <Controller
                                    ...
                                    render={({ field }) => (
                                        <Select
                                            ...
                                            value={field.value || ''}
                                            disabled={!watchedJsonParams?.colegio}
                                        >
                                            <SelectTrigger>
                                                <SelectValue placeholder="Selecciona..." />
                                            </SelectTrigger>
                                ...
                                <Controller
                                    ...
                                    render={({ field }) => (
                                        <Select
                                            ...
                                            value={field.value || ''}
                                            disabled={!watchedJsonParams?.nivel_educativo}
                                        >
                                            <SelectTrigger>
                                                <SelectValue placeholder="Selecciona..." />
                                            </SelectTrigger>
                ...
                {initialLeadData && (
                    <div className="space-y-6">
                        <WhatsAppContactCard lead={initialLeadData} />
                        <NotasSection leadId={initialLeadData.id} />
                    </div>
                )}
            </div>
        </form>
