...
export async function ejecutarMostrarDetalleOfertaAction(
    ...
    try {
        ...
        return {
            ...
            data: { // Este es FunctionResponseMediaData
                content: "Aquí tienes los detalles de la oferta solicitada:", // Un texto simple
                media: null,
                uiComponentPayload: { // El nuevo payload
                    componentType: "OfferDisplay", // O simplemente "Offer" y el frontend sabe qué componente usar
                    data: { /* ...el objeto rico con nombre, descripción, imágenes, videos ... */ }
                }
            }
        };
