...
export const ejecutarAgendarCitaAction: FunctionExecutor = async (argsFromIA, context) => {
    ...
    const datosParaConfirmar = { servicio_nombre: tipoCita.nombre, fecha_hora_deseada: fechaHora.toISOString(), nombre_contacto: nombreFinal, email_contacto: emailFinal!, telefono_contacto: telefonoCompleto!, motivo_de_reunion: argsValidados.motivo_de_reunion, oferta_Id: argsValidados.oferta_Id };
