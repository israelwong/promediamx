...
import { manejarInformacionGeneral } from '../tasks/manejarInformacionGeneral.handler';
...
export async function manejarConversacionGeneral(
    ...
    switch (intencionDetectada) {
        ...
        case 'solicitar_costos': handlerDirecto = manejarCostos; break;
        case 'saludar': handlerDirecto = manejarBienvenida; break;
        case 'solicitar_informacion_general': default: handlerDirecto = manejarInformacionGeneral; break;
    }
