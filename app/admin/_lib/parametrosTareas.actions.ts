...
// Asegúrate que la interfaz ParametroRequerido en types.ts ya refleja los campos:
// id, nombreVisible, nombreInterno, tipoDato, descripcion?, orden?, createdAt, updatedAt
import { ParametroRequerido } from './types';
import { Prisma } from '@prisma/client';

// --- Helper para generar nombre interno ---
// (Puedes mover esto a un archivo de utilidades si lo usas en más lugares)
...
// --- Tipo para los datos de CREACIÓN desde el formulario ---
// Solo necesita nombreVisible, tipoDato, descripcion
type CrearParametroRequeridoInput = Pick<ParametroRequerido, 'nombreVisible' | 'tipoDato' | 'descripcion'>;

// --- Tipo para los datos de EDICIÓN desde el formulario ---
// Solo puede editar nombreVisible, tipoDato, descripcion
type EditarParametroRequeridoInput = Pick<ParametroRequerido, 'nombreVisible' | 'tipoDato' | 'descripcion'>;
