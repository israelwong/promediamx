        ...
        <div className='bg-zinc-900/80 min-h-screen'>
            <div className='md:max-w-screen-md mx-auto text-center p-5'>
                <div className='mt-5 mb-2 flex justify-center '>
                    <Image className="" src='https://fhwfdwrrnwkbnwxabkcq.supabase.co/storage/v1/object/public/ProMedia/logos/promedia/favicon_color.svg' width={40} height={40} alt='Logo' />
                </div>
