...
interface ConfirmacionPagoEmailProps {
    ...
    nombreNegocio?: string; // Hacerlo no opcional si siempre se requiere
    logoNegocioUrl?: string | null;
    conceptoPrincipal?: string;
    montoPagado?: number;
    moneda?: string;
    idTransaccionStripe?: string | null; // Permitir null
    linkDetallesPedidoEnVitrina?: string | null;
    emailSoportePlataforma?: string;
}

// --- DATOS DE EJEMPLO PARA PREVISUALIZACIÓN ---
const defaultProps: ConfirmacionPagoEmailProps = {
    nombreComprador: 'Juan Ejemplo Pérez',
    nombreNegocio: 'El Negocio Fantástico de Prueba',
    logoNegocioUrl: 'https://www.gstatic.com/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png', // URL de un logo de placeholder
    conceptoPrincipal: 'Curso Increíble de Desarrollo Web Avanzado',
    montoPagado: 1299.50,
    moneda: 'MXN',
    idTransaccionStripe: 'pi_3RSabcdefghijklmnopqrstu',
    linkDetallesPedidoEnVitrina: `http://localhost:3000/vd/negocio-fantastico/pedidos/pedidoXYZ`, // Ejemplo
    emailSoportePlataforma: 'soporte@promedia.mx'
};
