...
export default function FichaMaximizaPotencialRRSS() {
    return (
        <div className='border border-yellow-800 p-5 rounded-md bg-zinc-900/50'>

            <p className='font-FunnelSans-SemiBold text-2xl mb-3 text-yellow-500'>
            ...
            <p className='text-zinc-300 text-2xl font-FunnelSans-Light mb-2'>
                😎 Lo que importa es la conversión
            </p>
