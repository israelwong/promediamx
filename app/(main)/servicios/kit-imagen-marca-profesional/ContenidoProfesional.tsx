...
export default function ContenidoProfesional() {
    ...
    return (
        <>
            <Head>
                <title>Contenido para Redes Sociales - ProMedia</title>
                <meta name="description" content="Ofrecemos creación de contenido atractivo y efectivo para redes sociales, ideal para empresas que buscan expandir su presencia en plataformas digitales." />
                <meta name="robots" content="index, follow" />
                <meta property="og:title" content="Contenido para Redes Sociales - ProMedia" />
                <meta property="og:description" content="Ofrecemos creación de contenido atractivo y efectivo para redes sociales, ideal para empresas que buscan expandir su presencia en plataformas digitales." />
