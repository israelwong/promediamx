...
export default function SolucionesLista() {
    ...
    return (
        <div>
            <div className='mb-5'>
                <h2 className='font-FunnelSans-SemiBold text-2xl bg-gradient-to-r from-yellow-400  to-red-500 text-transparent bg-clip-text'>
                    Soluciones en remarketing digital
                </h2>
                <p className='text-zinc-300 font-FunnelSans-Light max-w-screen-sm mx-auto mb-3'>
                    Contamos con herramietnas para aprovechas al máximo tus contactos y clientes
                </p>
            </div>
